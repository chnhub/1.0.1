...
//div模板
function getDivTemplate(params) {
	`<div id='floatdiv' style='z-index:9999; height:100px;width:100px;background-size:100% 100%;text-align: center;position: fixed; bottom:60px;right:10px'>
		<div style='height:100%;width:100%;font-size:10px;' hidden='hidden'>
